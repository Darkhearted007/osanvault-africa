#!/usr/bin/env python3
"""
Run this script in Termux to create DESIGN_REFERENCE.md:
  python3 write_design_ref.py
"""

import os

TARGET = os.path.expanduser("~/osanvault/apps/web/DESIGN_REFERENCE.md")
IMAGES_DIR = os.path.expanduser("~/osanvault/apps/web/public/design-refs")

os.makedirs(IMAGES_DIR, exist_ok=True)

content = r"""# Òsánvault Africa — UI/UX Design Reference
...
print(f"✅ DESIGN_REFERENCE.md written to: {TARGET}")
print(f"✅ design-refs folder ready at:    {IMAGES_DIR}")
print()
print("Next steps:")
print("  1. Copy your reference images to:", IMAGES_DIR)
print("  2. git add apps/web/DESIGN_REFERENCE.md apps/web/public/design-refs/")
print('  3. git commit -m "docs(web): add UI design reference"')
print("  4. git push")
